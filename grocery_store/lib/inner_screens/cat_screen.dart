...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<ProductModel> productByCat = productsProvider.findByCategory(catText);
    return Scaffold(
      appBar: AppBar(
        leading: BackWidget(),
        title: Text(
      ...
      body: productByCat.isEmpty
          ? EmptyProduct(
              text: 'No products belong in this category',
            )
              ...
              child: Column(
                children: [
                  ...
                  _searchController!.text.isNotEmpty && listSearch.isEmpty
                      ? EmptyProduct(
                          text:
                              'No products found, please enter a valid keyword')
                      : GridView.count(
                          shrinkWrap: true,
